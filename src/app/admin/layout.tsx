...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
      <div className={`${inter.variable}`}
        ...
        <div style={{ width: '100%', maxWidth: 360 }}>
          ...
          <p style={{ fontFamily: F.inter, fontSize: 12, color: '#444', textAlign: 'center', marginTop: 32 }}>
  ...
  return (
    <div className={`${inter.variable}`} style={{ height: '100dvh', display: 'flex', flexDirection: 'column', overflow: 'hidden', background: '#f6f5f4' }}>
      {/* Admin header */}
      <header style={{
